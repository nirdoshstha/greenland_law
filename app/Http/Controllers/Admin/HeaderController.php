...
class HeaderController extends BackendBaseController
{
    private $model;
    protected $base_route = 'header.';
    protected $view_path = 'admin.header.';
    protected $panel = 'Header';
    protected $img_path = 'uploads/header/';
    ...
    public function store(HeaderRequest $request){
        // We have already Make Request->HeaderRequest for Dynamic validation;
        // $aboutus = new About();
        if($this->model){
