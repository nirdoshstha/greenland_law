            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @foreach ($data as $datas)
                        ...
                        <td>
                            @if($datas->image)
                          <img src="{{asset($img_path.$datas->image)}}" width="100" class="img-fluid img-thumbnail"></td>
                          @else
                           {{'No Image'}}
                      @endif
                        </td>
                        {{--  <td><img src="{{asset($img_path,[$datas->image])}}" class="img-fluid" width="100"  /></td>  --}}
                        <td><input type="checkbox" {{$datas->status=='1'?'checked' : ''}} class="form-check-input"></td>
